...
const forgotPassword = async (req, res)=>{
    ...
    try {
        ...
        const transporter = nodemailer.createTransport({
            ...
            port: 587,
            auth: {
                user: 'ottis92@ethereal.email',
                pass: 'rXe2wMnPVsYQq86WSF'
            }
        });

        var mailOptions = {
        from: '"Rushikesh Pathade", <rushikeshpathade961@gmail.com>',
        to: oldUser.email,
        subject: 'Password Reset',
        text: link,
        html:"<b>You can reset your password Using this link!!!</b>"
        };
...
const resetPassword = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            return res.render("setNewPassword.ejs", { email: verify.email, status: "Not Verified" });
        } catch (error) {
